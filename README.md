...
- 📄 **Resume**: [Download Resume](https://drive.google.com/file/d/16Do3AXjS3QhsAXpuesYhyovlT8wZC7j5/view?usp=sharing)
...
<p align="left">
  ...
  <img src="https://img.shields.io/badge/Azure%20Service%20Bus-0089D6?style=for-the-badge&logo=microsoftazure&logoColor=white" alt="Azure Service Bus" />
...
- **High Throughput Backend Systems**: Engineered microservices API solutions handling **50,000+ daily requests** and high-volume data operations.
- **Enterprise Multi-Tenancy & Security**: Built multi-tenant RBAC access systems across 10+ organizational tenants.
- **Architecture & Quality**: Established standard repository/data-access layers using Dapper, Unit of Work pattern, and xUnit test suites targeting **>85% code coverage**.
- **Certified Expertise**: 
  - 🏆 *Foundational C# Certification* — Microsoft
  - 🏆 *SQL Certification (Basic, Intermediate, Advanced)* — HackerRank
